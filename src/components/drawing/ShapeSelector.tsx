...
const shapes: { type: ShapeType; name: string; preview: React.ReactNode; group?: string }[] = [
  ...
  // 3D shapes (star removed)
  { type: 'cube', name: 'Cube', preview: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="2"/></svg>), group: '3D' },
  { type: 'cylinder', name: 'Cylinder', preview: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><ellipse cx="12" cy="6" rx="9" ry="4"/><ellipse cx="12" cy="18" rx="9" ry="4"/><line x1="3" y1="6" x2="3" y2="18"/><line x1="21" y1="6" x2="21" y2="18"/></svg>), group: '3D' },
  { type: 'pyramid', name: 'Pyramid', preview: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="12,2 22,20 2,20"/></svg>), group: '3D' },
  { type: 'cone', name: 'Cone', preview: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><ellipse cx="12" cy="20" rx="9" ry="4"/><line x1="3" y1="20" x2="12" y2="2"/><line x1="21" y1="20" x2="12" y2="2"/></svg>), group: '3D' },
  { type: 'cuboid', name: 'Cuboid', preview: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="7" width="18" height="10" rx="2"/></svg>), group: '3D' },
  { type: 'hexagonalPrism', name: 'Hexagonal Prism', preview: (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="4,12 8,4 16,4 20,12 16,20 8,20"/></svg>), group: '3D' },
